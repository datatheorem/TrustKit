...
/**
 `TrustKit` is a utility class for setting up SSL pinning in an App that statically links TrustKit. 
...
/**
 ...
 @param trustKitConfig A dictionnary containing various keys for configuring the SSL pinning policy with TrustKit.
...
/**
 ...
 Initializing TrustKit requires supplying a dictionary containing domain names as keys and dictionaries as values. Each domain dictionary should specify some configuration keys, which will configure the pinning policy for this domain. For example:
 ...
 This value should be an array of algorithm constants (kTSKAlgorithm) TrustKit needs to support when generating public key hashes. Supporting multiple algorithms has a performance impact.
